...
class ProductsGroup(models.Model):
    ...
    parent = models.ForeignKey('self', on_delete=models.CASCADE, null=True,
                               blank=True, verbose_name='Родитель', related_name='group')
...
class Products(models.Model):
    ...
    group = models.ForeignKey(ProductsGroup, on_delete=models.PROTECT, null=True, blank=True,
                              verbose_name='Группа', related_name='products')
